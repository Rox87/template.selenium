    ...
    var __webpack_modules__ = {
        ...
        28230: (__unused_webpack_module, exports) => {
            ...
            exports.Frame = class {
                ...
                dispose() {
                    void 0 !== this.port && null !== this.port && (this.port = null);
                }
            };
        },
        ...
        21887: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            class TabApi {
                constructor(tab, contentScriptVersionToLoad, apiScriptVersionToLoad) {
                    var _a;
                    this.tab = tab, this.frames = null, this.id = null !== (_a = this.tab.id) && void 0 !== _a ? _a : 0, 
                ...
                dispose() {
                    if (this.frames && Object.keys(this.frames).length > 0) for (const [, frame] of Object.entries(this.frames)) frame.dispose();
                    this.frames = null;
                }
                execute(request) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        return yield this.ensurePortsAreSet(), logger_1.Logger.groupLoggingAsync((() => __awaiter(this, void 0, void 0, (function*() {
                            switch (request.name) {
                              ...
                              default:
                                return this.safeDefaultHandler(request);
                            }
                        }))), "Handling for request: ", request);
                    }));
                }
                safeDefaultHandler(request) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        try {
                            return yield this.defaultHandler(request);
                        } catch (e) {
                            return logger_1.Logger.error(e), yield this.synchronizeFrames(), this.defaultHandler(request);
                        }
                    }));
                }
                defaultHandler(request) {
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        if (null !== (_a = request.frameId) && void 0 !== _a || (request.frameId = 0), TabApi.isValidCssSelectorContentScriptRequest(request)) {
                            ...
                            if (!frame || frame.errorOccurred) throw new Error("Frame is not available.");
                            request.frameId = frame.frameId, request.parameters.cssSelector = cssSelector, request.parameters.cssSelectorPerFrame = void 0;
                        }
                        if (void 0 === (null === (_b = this.frames[request.frameId]) || void 0 === _b ? void 0 : _b.port) || null === (null === (_c = this.frames[request.frameId]) || void 0 === _c ? void 0 : _c.port)) throw new Error(`Connection is not available for frame: ${request.frameId}.`);
                ...
                testSelector(request) {
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        for (let i = 0; i < selectorsPerFrame.length; i++) {
                            ...
                            const response = yield this.safeDefaultHandler(request);
                ...
                extractHandpickedData(request) {
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        for (const selector of selectors) {
                            const response = yield this.safeDefaultHandler({
                                name: request.name,
                ...
                getChildren(request) {
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        const frameSelectors = Array.from(null !== (_b = null === (_a = request.parameters) || void 0 === _a ? void 0 : _a.cssSelectorPerFrame) && void 0 !== _b ? _b : []), element = yield this.safeDefaultHandler({
                        ...
                        if ("iframe" === elementTag || "frame" === elementTag) {
                            const frame = yield this.getFrameChildBySelectors(request.requestId, null === (_f = request.parameters) || void 0 === _f ? void 0 : _f.cssSelectorPerFrame), htmlElement = yield this.safeDefaultHandler({
                                name: "GetElementRequest",
                                requestId: request.requestId,
                ...
                getElementFromPoint(request) {
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        for (;;) {
                            const message = yield this.safeDefaultHandler(request), response = message;
                ...
                getIndexOfElement(request) {
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        parameters.specificElementCssSelectorPerFrame = void 0, this.safeDefaultHandler(request);
                    }));
                }
                getParent(request) {
                    var _a, _b;
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        response.result.cssSelectorString = frameSelectors.join(" > "), response) : frameSelectors.length > 0 ? (request.parameters = {
                            ...
                            cssSelectorPerFrame: frameSelectors
                        }, request.name = "GetElementRequest", this.safeDefaultHandler(request)) : response;
                    }));
                }
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        return this.extractionResult = extraction_result_1.ExtractionResult.pending(), setTimeout((() => __awaiter(this, void 0, void 0, (function*() {
                            ...
                            try {
                                ...
                                if (TabApi.isValidCssSelectorContentScriptRequest(request)) return void (this.extractionResult = extraction_result_1.ExtractionResult.complete(null === (_a = yield this.safeDefaultHandler(request)) || void 0 === _a ? void 0 : _a.result));
                ...
                ensurePortsAreSet() {
                    return __awaiter(this, void 0, void 0, (function*() {
                        this.frames && Object.keys(this.frames).length > 0 || (this.frames = {}, yield this.synchronizeFrames());
                    }));
                }
                synchronizeFrames() {
                    var _a;
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        for (const $frame of frames) if (null != $frame && !(null === (_a = this.frames[$frame.frameId]) || void 0 === _a ? void 0 : _a.port)) {
                            if ((0, can_scripts_be_injected_1.canScriptsBeInjected)($frame.url)) {
                                (0 === $frame.frameId ? yield this.injectScriptsToMainFrame() : yield this.injectScriptsToSubFrame($frame.frameId)) && this.setupConnection($frame);
                            }
                ...
                injectScriptsToMainFrame() {
                    return __awaiter(this, void 0, void 0, (function*() {
                        try {
                            return logger_1.Logger.log("Injecting scripts to main frame at tab: ", this.id), 
                            ...
                            throw logger_1.Logger.log("Unable to inject scripts to main frame at tab: ", this.id), 
                ...
                injectScriptsToSubFrame(frameId) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        let injectResult = !1;
                        return injectResult = yield (0, execute_with_timeout_1.executeWithTimeout)(TabApi.injectionTimeOut, function(id, contentScriptPath, apiScriptPath) {
                            return __awaiter(this, void 0, void 0, (function*() {
                                try {
                                    return yield chrome.scripting.executeScript({
                                        target: {
                        ...
                        }(this.id, this.contentScriptPath, this.apiScriptPath), !1), logger_1.Logger.log((injectResult ? "Injected" : "Unable to inject") + " scripts to frame: ", frameId, " at tab: ", this.id), 
                        injectResult;
                    }));
                }
                setupConnection(frame) {
                    ...
                    customPort.frameId = frame.frameId, frame.port = customPort) : logger_1.Logger.warn(`Port to frame '${frame.frameId}' at tab '${this.id}' could not be created.`);
                }
                sendMessage(message) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        const messagePort = this.frames[message.frameId].port;
                        return logger_1.Logger.log("Sending message to tab:", this.id, "and frame:", message.frameId, message), 
                        new Promise(((resolve, reject) => {
                            const disposeFrame = () => {
                                var _a;
                                null === (_a = this.frames[message.frameId]) || void 0 === _a || _a.dispose(), delete this.frames[message.frameId];
                            }, onMessage = m => {
                                logger_1.Logger.log("Received Message: ", m), m.requestId === message.requestId && (removeHandlers(), 
                                resolve(m));
                            }, onDisconnect = _ => {
                                logger_1.Logger.error("Port disconnected: ", message), removeHandlers(), disposeFrame(), 
                            ...
                            try {
                                ...
                                logger_1.Logger.error("Failed to post message: ", message, e), disposeFrame(), removeHandlers(), 
                                reject(e);
                            }
                        }));
                    }));
